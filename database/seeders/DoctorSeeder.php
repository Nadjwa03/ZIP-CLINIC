...
class DoctorSeeder extends Seeder
{
    ...
    {
        // Pastikan specialities sudah ada
        $orthodontic = Speciality::where('speciality_name', 'Spesialis Orthodonti')->first();
        $konservasi = Speciality::where('speciality_name', 'Spesialis Konservasi Gigi')->first();
        $periodonsia = Speciality::where('speciality_name', 'Spesialis Periodonsia')->first();

        // Jika specialities belum ada, create default
        if (!$orthodontic) {
            $orthodontic = Speciality::create([
        ...
        $doctors = [
            [
                ...
                'doctor' => [
                    ...
                    'speciality_id' => $orthodontic->speciality_id,  // ✅ FIXED: Gunakan ID
                    'phone' => '081234567801',
            ...
            [
                ...
                'doctor' => [
                    ...
                    'speciality_id' => $konservasi->speciality_id,  // ✅ FIXED: Gunakan ID
                    'phone' => '081234567802',
            ...
            [
                ...
                'doctor' => [
                    ...
                    'speciality_id' => $periodonsia->speciality_id,  // ✅ FIXED: Gunakan ID
                    'phone' => '081234567803',
        ...
        foreach ($doctors as $data) {
            ...
            $doctor = Doctor::create(array_merge(
                $data['doctor'],
                ['doctor_user_id' => $user->id]  // ✅ FIXED: Gunakan doctor_user_id
            ));
            ...
            foreach ($data['schedules'] as $schedule) {
                DoctorSchedule::create([
                    'doctor_user_id' => $doctor->doctor_user_id,  // ✅ FIXED: Gunakan doctor_user_id
