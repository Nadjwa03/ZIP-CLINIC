...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-600 mt-1">Lengkapi data pasien dengan benar</p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select id="id_type" 
                        name="id_type" 
                        required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#6B4423] focus:border-transparent bg-white">
                    ...
                    <option value="KK" {{ old('id_type') === 'KK' ? 'selected' : '' }}>KK</option>
                </select>
                @error('id_type')
    ...
    <div class="mb-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Kosongkan untuk menggunakan email akun: {{ Auth::user()->email }}</p>
                @error('email')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea id="allergies" 
                          ...
                          rows="2"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#6B4423] focus:border-transparent"
                          placeholder="Contoh: Alergi obat penisilin, makanan laut">{{ old('allergies') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea id="medical_history" 
                          ...
                          rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#6B4423] focus:border-transparent"
                          placeholder="Riwayat penyakit sebelumnya">{{ old('medical_history') }}</textarea>
            </div>
        </div>
    </div>
