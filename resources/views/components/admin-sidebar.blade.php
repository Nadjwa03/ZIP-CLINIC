<div class="h-full w-full flex flex-col py-4">
  ...
  <nav class="flex-1 flex flex-col gap-y-2 px-3 py-3 mt-3 overflow-y-auto">
    ...
    <!-- Services -->
    <a href="{{ route('admin.services.index') }}" class="w-full flex gap-x-2 p-3 group hover:bg-emerald-50 rounded-md {{ request()->routeIs('admin.services.*') ? 'bg-emerald-50' : '' }}">
      ...
      <span class="{{ request()->routeIs('admin.services.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600">Layanan</span>
    </a>


    <!-- Settings -->
    <a href="{{ route('admin.settings.index') }}" class="w-full flex gap-x-2 p-3 group hover:bg-emerald-50 rounded-md {{ request()->routeIs('admin.settings.*') ? 'bg-emerald-50' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" class="fill-current {{ request()->routeIs('admin.settings.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600 w-6 h-6" viewBox="0 -960 960 960">
      ...
      <span class="{{ request()->routeIs('admin.settings.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600">Pengaturan</span>
    </a>
...
<a href="{{ route('admin.invoices.index') }}" 
   class="w-full flex gap-x-2 p-3 group hover:bg-emerald-50 rounded-md {{ request()->routeIs('admin.invoices.*') ? 'bg-emerald-50' : '' }}">
  <svg xmlns="http://www.w3.org/2000/svg" class="fill-current {{ request()->routeIs('admin.invoices.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600 w-6 h-6" viewBox="0 -960 960 960">
    <path d="M240-80q-50 0-85-35t-35-85v-120h120v-560l60 60 60-60 60 60 60-60 60 60 60-60 60 60 60-60 60 60 60-60v680q0 50-35 85t-85 35H240Zm480-80q17 0 28.5-11.5T760-200v-560H320v440h360v120q0 17 11.5 28.5T720-160ZM360-600v-80h240v80H360Zm0 120v-80h240v80H360Zm320-120q-17 0-28.5-11.5T640-640q0-17 11.5-28.5T680-680q17 0 28.5 11.5T720-640q0 17-11.5 28.5T680-600Zm0 120q-17 0-28.5-11.5T640-520q0-17 11.5-28.5T680-560q17 0 28.5 11.5T720-520q0 17-11.5 28.5T680-480ZM240-160h360v-80H200v40q0 17 11.5 28.5T240-160Zm-40 0v-80 80Z"/>
  </svg>
  <span class="{{ request()->routeIs('admin.invoices.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600">Invoice</span>
  ...
  @endif
    ...
    <a href="{{ route('admin.specialities.index') }}"
       class="w-full flex gap-x-2 p-3 group hover:bg-emerald-50 rounded-md {{ request()->routeIs('admin.specialities.*') ? 'bg-emerald-50' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" class="fill-current {{ request()->routeIs('admin.specialities.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600 w-6 h-6" viewBox="0 -960 960 960">
      ...
      <span class="{{ request()->routeIs('admin.specialities.*') ? 'text-emerald-600' : 'text-neutral-700' }} group-hover:text-emerald-600">Spesialisasi</span>
    </a>
