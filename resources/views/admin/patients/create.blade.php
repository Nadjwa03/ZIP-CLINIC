...
@section('title', 'Tambah Pasien Baru | Klinik ZIP')
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm mt-1">Lengkapi form di bawah untuk mendaftarkan pasien baru</p>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.patients.store') }}" class="max-w-4xl">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="id_type" 
                        ...
                        <option value="KK" {{ old('id_type') === 'KK' ? 'selected' : '' }}>Kartu Keluarga</option>
                    </select>
                    @error('id_type')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="allergies" 
                              ...
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('allergies') border-red-500 @enderror">{{ old('allergies') }}</textarea>
                    @error('allergies')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="medical_history" 
                              ...
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('medical_history') border-red-500 @enderror">{{ old('medical_history') }}</textarea>
